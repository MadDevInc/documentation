...
| [**Épicos (EP)**](#épicos-ep)                             | São grandes blocos de trabalho dentro de cada tema. Eles descrevem objetivos amplos, como "Criação de Cenários" ou "Desenvolvimento de Mini-Games".                           | Divida o trabalho em épicos para organizar tarefas maiores dentro de cada tema.                                        |
